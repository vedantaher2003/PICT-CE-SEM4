...
global _start
_start: 
    smsw eax                    ;Reading Machine Status Word into EAX  

    mov [cr0_data],rax          ;Store MSW into CR-0 variable
...
prmode: 
    print pmodemsg, pmsg_len    ;msg for protected mode

nxt1: 
    sgdt [gdt]                  ;Store GDT, LDT, IDT, TR content
    sldt [ldt]
    sidt [idt]
    str [tr]
    ...
    print trmsg,tmsg_len        ;Task Register
